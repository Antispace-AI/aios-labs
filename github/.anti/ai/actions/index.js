...
exports.git_changes_from_recent_commits = git_changes_from_recent_commits;
exports.get_latest_commits = get_latest_commits;
exports.get_my_github_info = get_my_github_info;
async function git_changes_from_recent_commits(octokit, params) {
...
async function get_latest_commits(octokit, params) {
    ...
    try {
        ...
        for (const repo of response.data) {
            try {
                ...
                console.log(`Error fetching commits for ${repo.name}: ${repoError.message}`);
...
async function get_my_github_info(octokit, params) {
    try {
